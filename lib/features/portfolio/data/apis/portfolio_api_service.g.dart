...
class _PortfolioApiService implements PortfolioApiService {
  ...
  Future<Map<String, CoinPriceModel>> getSimplePrices(
    ...
    final _options = _setStreamType<Map<String, CoinPriceModel>>(
    ...
    late Map<String, CoinPriceModel> _value;
    try {
      _value = _result.data!.map(
        (k, dynamic v) =>
            MapEntry(k, CoinPriceModel.fromJson(v as Map<String, dynamic>)),
      );
    } on Object catch (e, s) {
